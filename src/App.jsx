...
import ShowManufacturer from "./features/fleet/ui/pages/AircraftManufacturer/ShowManufacturer";
export default function App() {
  const { isDark } = useTheme();
  const appStyle = clsx(isDark && "dark", "w-full h-[100svh] overflow-hidden", "text-gray-900 dark:text-slate-100", "bg-slate-100 dark:bg-gray-900");
  return (
