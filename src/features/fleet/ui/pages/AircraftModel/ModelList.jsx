            ...
            <div className="flex flex-col w-full h-full overflow-auto">
                <div className="flex justify-between items-center p-4 w-full">
                    ...
                    <div className="flex items-center gap-2 ">
                        <Link className="underline hover:text-primary grow" to="/fleet/aircraft/manufacturer">Manufacturer</Link>
                        <select className="select select-bordered" onChange={(e) => { setManufacturerId(e.target.value) }}>
