...
const useDeleteManufacturer = () => {
  ...
  return useMutation({
    mutationFn: (documentId) => AircraftRepo.delete_manufacturer(documentId),
    ...
    onSuccess: async (res) => {
      ...
      if (res) {
        queryClient.setQueryData(["manufacturers"], (prev) => prev.filter((manufacturer) => manufacturer.documentId !== res.documentId));
        navigate("../");
      }
    },
    onError: async () => {
