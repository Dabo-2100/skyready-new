...
export default function LoginPage() {
  ...
  const formStyle = useMemo(() => clsx("w-[90%] md:w-100", "flex flex-col gap-3", "py-5 px-4 rounded-lg", "bg-slate-300 dark:bg-black/30"), []);
          ...
          <Form>
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="w-full flex justify-between flex-wrap">
                ...
                <Link to="/forget" className="label text-sm">
                  Forget Password ?
                </Link>
              </div>
